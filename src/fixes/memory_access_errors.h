...
namespace Fixes::MemoryAccessErrors
{
    namespace detail
    {
        static void InstallSnowMaterialCaseFix()
        {
            ...
            REL::Relocation funcHook{ RELOCATION_ID(100563, 107298), VAR_NUM(0x4E0, 0x6A6, 0x4E0) };
            REL::Relocation funcExit{ RELOCATION_ID(100563, 107298), VAR_NUM(0x5B6, 0x770, 0x5B6) };
        ...
        inline void InstallBSShadowDirectionalLightUseAfterFree()
        {
            ...
            REL::Relocation target{ RELOCATION_ID(101499, 108496), VAR_NUM(0x1AFD, 0x1BED, 0x1AFD) };
