...
namespace Fixes::BSLightingShaderParallaxBug
{
    ...
    inline void Install()
    {
        ...
        // AE1799 recompile shifted this instruction from +0xB5D to +0xB7F; verified via
        // Ghidra decompile of both binaries (identical `TEST EAX,0x21c00`, no other layout change).
