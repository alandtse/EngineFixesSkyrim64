...
#define EF_SETTINGS_FIXES(X)                                                                                                                                                                                                                                      \
    ...
    X(Bool, bShadowLightCrossThreadFreeCrash, true, "fixes a crash when a light released on a job thread, e.g. by the console coc command, is freed while the render thread still uses it; frees are deferred to the end of the frame")                           \
